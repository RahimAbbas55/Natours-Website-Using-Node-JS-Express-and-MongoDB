...
var hideAlert = exports.hideAlert = function hideAlert() {
  var doc = document.querySelector('.alert');
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(username, userEmail, pass, confirmPass, userRole) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          break;
        case 9:
          (0, _alerts.showAlert)('error', "You can not register as a ".concat(userRole, "! "));
        case 10:
          _context.next = 15;
          break;
        case 12:
...
var login = exports.login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(em, pass) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updatePass.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePass = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable*/
var updatePass = exports.updatePass = /*#__PURE__*/function () {
  ...
  return function updatePass(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripePromise = (0, _stripeJs.loadStripe)("pk_test_51OkuHnDQv4J2xTbnrA0MO4VnG7Fj3hQLepJHKaXqnWwaCBGikPfpQAhC0F6b0DisuIkfmiENz9oZIf2VqEXAnkjt004Z4u2237");
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId, res) {
    var session, id, stripe;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("http://127.0.0.1:8000/api/v1/booking/checkout-session/".concat(tourId));
        case 3:
          session = _context.sent;
          id = session.data.session.id; // 2) Create checkout form 
          _context.next = 7;
          return stripePromise;
        case 7:
        ...
        case 10:
          (0, _alerts.showAlert)('success', 'Purchase successful!');
          _context.next = 17;
          break;
        case 13:
          _context.prev = 13;
          ...
          (0, _alerts.showAlert)('error', _context.t0.message); // Show only error message
        case 17:
        case "end":
          return _context.stop();
      }
...
},{"@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.mjs","./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _updatePass = require("./updatePass");
...
var userSignUpForm = document.querySelector('.form-user-data.signup');
...
if (userSignUpForm) {
  userSignUpForm.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(n, em, pass, confPass, userRole);
  });
}
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updatePass.updatePass)(passwordCurrent, password, passwordConfirm);
